            ...
            if (!b.modules.async) {
                ...
                e.prototype = {
                    ...
                    addEventListener: function (a, b) {
                        this._listeners && (this._listeners[a] || (this._listeners[a] = []), this._listeners[
                            a].push(b))
                    },
                    ...
                    Bind: function (a, b) {
                        return {
                            next: function (c, e) {
                                ...
                                a.status == "ready" ? (a.addEventListener("complete", d), a.start()) :
                                    a.status == "running" ? a.addEventListener("complete", d) : d(a)
                            }
                        }
                    }
                };
